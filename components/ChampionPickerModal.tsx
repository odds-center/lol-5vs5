          ...
          <div className="flex flex-wrap justify-center gap-1.5">
            {CHAMPION_NAMES.map((name) => (
              <button
                ...
                className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded border border-lol-border bg-lol-bg-card transition-colors hover:border-lol-gold/60 hover:bg-lol-card sm:h-11 sm:w-11"
                title={name}
              >
                <Image
                ...
                />
                <span className="absolute inset-0 z-0 flex items-center justify-center bg-lol-bg-card/90 text-[10px] font-medium text-lol-gold-bright">
